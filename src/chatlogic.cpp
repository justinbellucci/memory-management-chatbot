...
ChatLogic::ChatLogic()
{
    ...
    // create unique pointer to ChatBot class and allocate memory
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            _nodes.emplace_back(std::make_unique<GraphNode>(id)); // TODO: Create instance of GraphNode
